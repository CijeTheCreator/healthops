    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          border: {
            gray: "var(--color-brand-border-gray)",
            warm: "var(--color-brand-border-warm)",
            dark: "var(--color-brand-border-dark)",
          },
          ...
          text: {
            muted: "var(--color-brand-text-muted)",
            secondary: "var(--color-brand-text-secondary)",
          },
        },
      },
      borderRadius: {
